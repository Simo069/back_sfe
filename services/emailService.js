  ...
  const htmlContent = `
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <p>Bonjour <strong>${demande.firstName} ${
    demande.lastName
  }</strong>,</p>
    ...
    demande.dateFin
          ...
          <div class="footer">
            <p>Demande approuvée le ${new Date().toLocaleDateString(
              "fr-FR"
            )} à ${new Date().toLocaleTimeString("fr-FR")}</p>
            <p>Validateur final : ${validateur.firstName} ${
    validateur.lastName
  }</p>
    ...
    demande.lastName
          ...
          <div class="details">
            ...
            <ul>
              ...
              <li><strong>Direction :</strong> ${demande.direction}</li>
              <li><strong>Environnement :</strong> ${demande.environnement}</li>
              <li><strong>Période demandée :</strong> Du ${new Date(
                demande.dateDebut
              ).toLocaleDateString("fr-FR")} au ${new Date(
    demande.dateFin
  ).toLocaleDateString("fr-FR")}</li>
          ...
          <div class="footer">
            <p>Demande rejetée le ${new Date().toLocaleDateString(
              "fr-FR"
            )} à ${new Date().toLocaleTimeString("fr-FR")}</p>
